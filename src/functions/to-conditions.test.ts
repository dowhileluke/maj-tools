...
test('overtake dealer for 3rd', () => {
	...
	const conditions = toConditions({ scores, dealerIndex: 1, })
...
test('correctly identify dealer tsumo ranking v1', () => {
	...
	const conditions = toConditions({ scores, dealerIndex: 2, repeatCount: 2, })
...
test('correctly identify dealer tsumo ranking v2', () => {
	...
	const conditions = toConditions({ scores, dealerIndex: 2, })
...
test('leftover stick with direct ron', () => {
	...
	const conditions = toConditions({ scores, dealerIndex: 2, leftoverCount: 1, })
